...
type UserGormRepo struct{ db *db.Database }

func NewUserGormRepo(database *db.Database) *UserGormRepo { return &UserGormRepo{db: database} }
...
func (r *UserGormRepo) DeleteByID(id uint) error { return r.db.Delete(&domain.User{}, id).Error }
